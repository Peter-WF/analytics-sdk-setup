...
description: 使用此技能来审计、安装、比较、对齐或修复 TikTok Pixel 与 Meta Pixel 集成，并为编码代理提供清晰的执行模式决策、跨平台治理规则和隐私安全默认值。
---

# Analytics SDK 设置

当用户希望编码代理在真实代码库中检查、安装、比较、对齐或修复 TikTok Pixel 和 Meta Pixel 跟踪时，使用此技能。
...
- 对齐 TikTok 和 Meta 的事件跟踪
- 比较代码库中 TikTok 和 Meta 的实现
- 调查重复 Pixel 初始化
